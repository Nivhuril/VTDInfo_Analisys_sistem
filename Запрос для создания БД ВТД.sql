...
CREATE TABLE [VTD].[pipelineInfo] (  
    ...
    ADD CONSTRAINT [Defolt_zero_for_all_pipelineInfo] DEFAULT 0 FOR [itemNumber, pipelineName, pipelineSection, pipeDiameter, principal, examinationDate, designPressure, operatingPressure, comissioningYear];
    GO  
    ...
    ADD CONSTRAINT [Defolt_zero_for_all_pipelineInfo] DEFAULT 0 FOR [itemNumber, pipeNumber, odometrDist, pipeLength, distanceFromReferencePoints, characterFeatures, clockOrientation, bendOfPipe, jointAngle, Latitude, Longitude, heightAboveSeaLevel, note];
    GO  
    ...
    ADD CONSTRAINT [Defolt_zero_for_all_anomalyLogLine] DEFAULT 0 FOR [itemNumber, odometrDist, distanceFromTransverseWeld, distanceFromReferencePoints, featuresCharacter, classOfSize, featuresOreientation, length, widht, depthInProcent, depthInMm, extOrInt, KBD, defectAssessment, Latitude, Longitude, heightAboveSeaLevel, note]; 
    GO  
...
CREATE TABLE [VTD].[furnishingsLog] (  
    ...
    ADD CONSTRAINT [Defolt_zero_for_all_furnishingsLog] DEFAULT 0 FOR [itemNumber, pipeNumber, odometrDist, pipeLength, distanceFromTransverseWeld, 
    characterFeatures, designations, marker, distanceToNextFeature, Latitude, Longitude, heightAboveSeaLevel, note];
    GO  
